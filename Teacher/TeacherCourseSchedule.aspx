<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherCourseSchedule.aspx.cs" Inherits="Course.Teacher.TeacherCourseSchedule" %>
    ...
    <div style="height: 720px; width: 1280px; margin-left: 300px">
        <div style="float:left; width: 240px; height: 720px; background-color:#23274F">
            <div style="margin-top: 30px; width: 189px; margin-left: 24px; margin-bottom:60px;">
                <h1 style="color:white; margin-left: 1px; width: 246px;">任课老师系统</h1>
            </div>
            ...
            <asp:Button ID="Button2" runat="server" Text="课表" BackColor="#706E97" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="80px" OnClick="Button2_Click" Width="240px" />
        </div>
        <div style="width: 1040px; float:left; height: 720px; background-color:#AE92D6">
            ...
            <div style="height: 56px; margin-left: 0px; padding-left:35px; width: 982px;">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:SchoolConnectionString %>" SelectCommand="SELECT [TeaName], [SubjectName], [CourseStartTime], [CourseEndTime] FROM [View_1] WHERE (([CourseWeek] = @CourseWeek) AND ([TeaName] = @TeaName))">
                    <SelectParameters>
                        <asp:Parameter DefaultValue="1" Name="CourseWeek" Type="String" />
                        <asp:Parameter DefaultValue="张峰" Name="TeaName" Type="String" />
                    </SelectParameters>
                </asp:SqlDataSource>
            </div>
        </div>
