<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherSelf.aspx.cs" Inherits="Course.Teacher.TeacherSelf" %>
...
<body>
    ...
    <div style="height: 720px; width: 1280px; margin-left: 300px">
        <div style="float:left; width: 240px; height: 720px; background-color:#23274F">
            ...
            <asp:Button ID="Button2" runat="server" Text="课表" BackColor="#23274F" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="80px" OnClick="Button2_Click" Width="240px" />
        </div>
