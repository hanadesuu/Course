<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseTeacherLogin.aspx.cs" Inherits="Course.CourseTeacherLogin" %>
        ...
        <div style="width: 851px; float:left; height: 715px;">
            ...
            <div style="margin-left: 167px; margin-top: 53px; width: 363px; height: 303px;">
                ...
                <div style="height: 94px; margin: 30px">
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" Height="40px" Width="300px" BorderStyle="None" Font-Size="Large"></asp:TextBox>
                </div>
