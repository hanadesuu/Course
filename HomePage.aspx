<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="Course.HomePage" %>
    ...
    <form id="form1" runat="server">
        <div style="height: 720px; width: 1280px; margin-left: 300px; background-color:#AE92D6">
            ...
            <div style="width: 851px; float:left; height: 715px;">
                ...
                <br />
                <br />
                <div style="float:left; width: 80px; margin-left: 243px;"><img style="width: 70px; height: 60px; margin-top: 12px;" src="/Image/logo.png" /></div>
                <div style="float:left; margin-top: 0px;"><h1 style="margin-left: 0px; margin-bottom: 0px;">排课管理系统</h1></div>
