<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaderTrainingPlan.aspx.cs" Inherits="Course.Leader.LeaderTrainingPlan" %>
...
<body>
    ...
    <div style="height: 720px; width: 1280px; margin-left: 300px">
        <div style="float:left; width: 240px; height: 720px; background-color:#23274F">
            ...
            <asp:Button ID="Button2" runat="server" Text="审核培养计划" BackColor="#706E97" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="80px" OnClick="Button2_Click" Width="240px" />
            <asp:Button ID="Button3" runat="server" Text="审核课表" BackColor="#23274F" BorderStyle="None" Font-Bold="True" Font-Size="Large" ForeColor="White" Height="80px" OnClick="Button3_Click" Width="240px" />
        </div>
        <div style="width: 1040px; float:left; height: 720px; background-color:#AE92D6">
            <div style="float:left; width: 907px;">
                <h1 style="margin-left: 30px; margin-top: 36px; width: 273px;">审核培养计划</h1>
            </div>
